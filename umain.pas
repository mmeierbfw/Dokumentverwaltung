...
type
  ...
  private
    ...
    FisTernes : Boolean;
    idnotset  : Boolean;
    procedure cursorwaiting;
    procedure cursorrunning;
...
begin
  ...
  for dateiname in dateilist do begin
    ...
    tmpfile := gettmpfile(ExtractFileName(tmp));
...
procedure Tformmain.cursorrunning;
begin
  Screen.Cursor := crdefault;
end;

procedure Tformmain.cursorwaiting;
begin
...
begin
  ...
  case Tag of
    ZwischenablsgINT, MontageINT, ReklamationINT:
      // fallen in die aktuelle Periode
      datemitpunkt := datestring;
    KostenINT, SonstigesInt: // in nächste Periode
      begin
        abrdat := abrdat + 365;
        DateTimeToString(datemitpunkt, 'dd.mm.yy', abrdat);
      end
  else DateTimeToString(datemitpunkt, 'dd.mm.yy', abrdat);
  end;
  Result := datemitpunkt;
end;
